...
Means of skin-conductance reactivity by video condition. 95% confidence intervals are in blue (online version).
...
The extension is that this analysis was performed with bayesian linear regression, instead of frequentist linear regression.
